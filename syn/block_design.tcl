...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set gpio_o_0 [ create_bd_port -dir O -from 0 -to 0 gpio_o_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#ENET Reset#UART 0#UART 0#GPIO#GPIO#GPIO#GPIO#Enet\
...
0#Enet 0} \
    CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#rx#tx#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio}\
\
  ...
  connect_bd_net -net neorv32_vivado_ip_0_gpio_o [get_bd_pins neorv32_vivado_ip_0/gpio_o] [get_bd_ports gpio_o_0]
  connect_bd_net -net neorv32_vivado_ip_0_uart0_txd_o [get_bd_pins neorv32_vivado_ip_0/uart0_txd_o] [get_bd_ports uart0_txd]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins neorv32_vivado_ip_0/clk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins neorv32_vivado_ip_0/resetn]
  connect_bd_net -net uart0_rxd_i_0_1 [get_bd_ports uart0_rxd] [get_bd_pins neorv32_vivado_ip_0/uart0_rxd_i]
